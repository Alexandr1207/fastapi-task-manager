...
Revision ID: 2e2a3ba07f63
Revises: 93990a7e1002
Create Date: 2026-07-10 17:56:03.468223
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['category_id'], ['categories.id'], name=op.f('tasks_category_id_fkey'), ondelete='SET NULL'),
